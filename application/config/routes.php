...
$route['^introduction/(:any)/(:any)'] = "controller_home/introduction/$1/$2";
$route['^login'] = "controller_home/login";
$route['^login_twitter'] = "controller_home/login_twitter";
$route['^tweet'] = "controller_home/tweet";
...
//     get 'login_twitter' => 'pages#login_twitter'
//     get 'tweet' => 'pages#tweet'
//     post 'tweet' => 'pages#tweet'
//     get 'contact' => 'pages#contact'
//     post 'contact' => 'pages#contact'
//     get 'participating' => 'pages#participating'
